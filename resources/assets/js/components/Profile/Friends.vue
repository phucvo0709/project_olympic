<template>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-6" v-if="!pendingFriends[0]">
                <div class="ui-block">
                        ...
                        <div class="friend-item-content">
                            ...
                            <div class="friend-avatar">
                                ...
                                <div class="author-content">
                                    <a href="#" class="h5 author-name">No Friend Pending</a>
                                </div>
                            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-6" v-for="pendingFriend in pendingFriends" v-else>
                <div class="ui-block">
                    <!-- Friend Item -->
                    <div class="friend-item">
                        <div class="friend-header-thumb">
        ...
        <vue-pending-paginate></vue-pending-paginate>
        <h3>All Friend</h3>
        <div class="row">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-6" v-if="!allFriend[0]">
                <div class="ui-block">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-6" v-for="friend in allFriend" v-else>
                <div class="ui-block">
                    <!-- Friend Item -->
                    <div class="friend-item">
                        <div class="friend-header-thumb">
                        ...
                        <div class="friend-item-content">
                            ...
                            <div class="friend-avatar">
                                <div class="author-thumb">
                                    <img style="max-width:100px; max-height:100px" :src="friend.avatar" alt="author">
                                </div>
                                <div class="author-content">
                                    <router-link :to="{ name: 'about' , params: { slug: friend.slug } }" class="h5 author-name">{{friend.name}}</router-link>
                                </div>
                            </div>
                            ...
                            <div class="swiper-container" data-slide="fade">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="friend-count" data-swiper-parallax="-500">
                                            <a class="friend-count-item">
                                                <div class="title" v-if="friend.gender = 1">Male</div>
                                                <div class="title" v-else>Female</div>
                                            </a>
                                        </div>
                                        <div class="control-block-button" data-swiper-parallax="-100">
...
<script>
    ...
    export default {
        mounted: function(){
            ...
            this.$store.dispatch('getAllFriend')
        },
        computed:{
            ...mapGetters({
        ...
        components: {
            'vue-pending-paginate': require('./FriendPaginate')
        },
        data() {
            return {
